                            ...
                            <tbody>
                                ...
                                @foreach ($tahfidzan as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="border-0 w-auto inputText" data-id="{{ $row->id }}" data-id-ustad="{{ $row->id_ustad }}" name="catatanMurojaah" id="catatan-murojaah" value="{{ isset($row->catatan) ? $row->catatan : '' }}">
                                        </td>
