                            ...
                            <tbody>
                                ...
                                @foreach ($tahfidzan as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="border-0 w-auto inputText" data-id="{{ $row->id }}" data-id-ustad="{{ $row->id_ustad }}" name="catatanZiyadah" id="catatan-ziyadah" value="{{ isset($row->catatan) ? $row->catatan : '' }}">
                                        </td>
...
<script>
    $(document).ready(function () {
        function calculateValues(rowId) {
            ...
            let jmlZiyadah = capaianAwal + capaianAkhir;

            return { jmlZiyadah };
        }

        function updateDisplayedValues(rowId, values) {
            $('#jml-' + rowId).text(values.jmlZiyadah);
        }
