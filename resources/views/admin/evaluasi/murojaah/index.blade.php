            ...
            <div class="card-content">
                <div class="card-body">
                      ...
                      <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-murojaah" role="tabpanel" aria-labelledby="nav-murojaah-tab">
                                    ...
                                    <div class="tab-pane fade show active" id="murojaah-evaluasi" role="tabpanel" aria-labelledby="murojaah-evaluasi-tab">
                                        ...
                                        <div class="table-responsive table-wrapper">
                                            <table class="table table-lg">
                                                ...
                                                <tbody>
                                                    @php
                                                        $murojaahEvaluasi = $dataMurojaah->filter(function ($item) {
