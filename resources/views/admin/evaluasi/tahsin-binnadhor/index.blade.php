            ...
            <div class="card-content">
                <div class="card-body">
                      ...
                      <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-tahsin-binnadhor" role="tabpanel" aria-labelledby="nav-tahsin-binnadhor-tab">
                            {{-- Tab Evaluasi Tahsin --}}
                            <div>
                                <ul class="nav nav-tabs d-flex justify-content-center gap-1" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active btn btn-danger" id="tahsin-binnadhor-evaluasi-tab" data-bs-toggle="tab" data-bs-target="#tahsin-binnadhor-evaluasi" type="button" role="tab" aria-controls="tahsin-binnadhor-evaluasi" aria-selected="true">Evaluasi</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link btn btn-success" id="tahsin-binnadhor-selesai-tab" data-bs-toggle="tab" data-bs-target="#tahsin-binnadhor-selesai" type="button" role="tab" aria-controls="tahsin-binnadhor-selesai" aria-selected="false">Selesai</button>
                                    </li>
                                </ul>
                                {{-- Tab Content --}}
                                <div class="tab-content" id="myTabContent">
                                    {{-- Content Evaluasi Tahsin --}}   
                                    <div class="tab-pane fade show active" id="tahsin-binnadhor-evaluasi" role="tabpanel" aria-labelledby="tahsin-binnadhor-evaluasi-tab">
                                            ...
                                            <table class="table table-lg">
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        $murojaahSelesai = $dataTahsin->filter(function ($item) {
                                    ...
                                    <div class="tab-pane fade" id="tahsin-binnadhor-selesai" role="tabpanel" aria-labelledby="tahsin-binnadhor-selesai-tab">
