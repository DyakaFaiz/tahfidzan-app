...
class ZiyadahController extends Controller
{
    public function index()
    {
        ...
        switch($roleUser) {
            case 1:
                $tahfidzan = Ziyadah::select(
                    ...
                    ->leftJoin('santri as santri', 'santri.id', '=', 'ziyadah.id_santri')
        ...
        $data = [
            'tahfidzan'  => $tahfidzan,
            'title'  => 'Ziyadah',
            'pageHeading'   => 'Tahfidzan Harian Ziyadah ' . ($roleUser == 1 ? '| ADMIN' : ''),
            'url'   => 'ketahfidzan/tahfidzan-admin/ziyadah',
            'waktu'   => $waktu,
            'juz'   => $juz,
            'pojok'   => $pojok,
            'status'   => $status,
        ...
        return view('admin.tahfidzan-harian.ziyadah.index', $data);
    }
